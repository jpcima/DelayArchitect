...
class mydsp {
 ...
 public:
	...
	void compute(int count, FAUSTFLOAT const* const* inputs, FAUSTFLOAT* const* outputs) {
		...
		float fSlow5 = (0.5f * (fSlow2 / fSlow4));
		float fSlow6 = ((1.0f - fSlow3) / fSlow4);
		float fSlow7 = ((-1.0f - fSlow1) / fSlow4);
		float fSlow8 = (1.0f / fSlow4);
		float fSlow9 = (0.5f * fSlow2);
		float fSlow10 = (0.0f - (2.0f * fSlow1));
		for (int i0 = 0; (i0 < count); i0 = (i0 + 1)) {
			float fTemp0 = float(input0[i0]);
			fVec0[0] = (fSlow5 * fTemp0);
			fVec1[0] = (fVec0[1] - (fSlow6 * fRec0[1]));
			fVec2[0] = (fSlow7 * fTemp0);
